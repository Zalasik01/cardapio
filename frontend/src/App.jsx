...
import PaginaEstoque from './pages/admin/PaginaEstoque'
import PaginaDivulgacao from './pages/admin/PaginaDivulgacao'
      ...
      <AuthProvider>
        <Routes>
          ...
          >
            ...
            <Route path="divulgacao" element={<PaginaDivulgacao />} />
