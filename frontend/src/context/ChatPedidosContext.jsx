...
export const RASCUNHO_VAZIO = {
  ...
  enderecoComplemento: '', enderecoBairro: '', enderecoCidade: '', taxaEntrega: null, pagamentos: [], formaLegada: null, descontoTipo: 'PERCENTUAL', descontoValor: null, observacoes: '', itens: [],
}
